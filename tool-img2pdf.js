  ...
  async function addFiles(fileList) {
    ...
    for (const file of fileList) {
      ...
      try {
        ...
        // Don't let one bad file abort the rest of the batch — log it,
        // skip it, and keep processing whatever else was selected.
    ...
    render();
    if (skipped) {
      Utils.toast(`Added ${fileList.length - skipped} image(s) — skipped ${skipped} that couldn't be read.`, skipped === fileList.length);
    }
  }
